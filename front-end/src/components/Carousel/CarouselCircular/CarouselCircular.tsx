  ...
  return (
    <div className="carouselCircular" ref={handleSetWrapper}>
      <div className="carouselCircular__buttonsContainer">
        <button
          onClick={onPrev}
          className="carouselCircular__button carouselCircular__button--prev"
        />
        <button
          onClick={onNext}
          className="carouselCircular__button carouselCircular__button--next"
        />
      </div>
      <CarouselHandle onMouseDown={onMouseDown}>
        <div
          className="carouselCircular__items"
