...
import InputForm from "../Form/components/Inputs/InputForm/InputForm";
import CheckBoxDefault from "../Form/components/Inputs/CheckBoxDefault/CheckBoxDefault";
    ...
    <div className="newsLetter">
      <div className="newsLetter__container">
        <div className="newsLetter__titleContainer">
          <TextDefault className="newsLetter__title">
            Inscreva-se na nossa Newsletter!
          </TextDefault>
        </div>
        <form className="newsLetter__formContainer" onSubmit={postForm}>
          <InputForm
            id="client"
            label="Nome*"
            name="client"
