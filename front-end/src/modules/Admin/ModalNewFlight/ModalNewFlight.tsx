    ...
    <div className="modalNewFlight">
      ...
      <div className="modalNewFlight__grid">
        <InputDate
          ...
          onChange={(e) => {
            changeState("data_voo", "value", e.target.value);
          }}
        />
        <InputText
          id="time"
          ...
          onChange={(e) => {
            changeState("hora", "value", e.target.value);
          }}
        />
        <InputText
          id="origin"
          ...
          onChange={(e) => {
            changeState("origem", "value", e.target.value);
          }}
        />
        <InputText
          id="destination"
          ...
          onChange={(e) => {
            changeState("destino", "value", e.target.value);
          }}
        />
        <InputCurrency
          id="price"
          ...
          onChange={(e) => {
            changeState("valor_passagem", "value", e.target.value);
          }}
        />
        <InputText
          id="seatsTotal"
          ...
          onChange={(e) => {
            changeState("poltronas", "value", e.target.value);
          }}
        />
        <ButtonDefault children={"Cancelar"} color="white" onClick={closeModal} />
        <ButtonDefault children={"Confirmar embarque"} onClick={onSubmit} />
      </div>
    </div>
  );
};
